<div class="row text-center pb-5">
  ...
  <div class="col">
    <img src="/wp-content/themes/sage/resources/assets/images/icon_piggy-bank.png" alt="icon" />
    <h5>Sample Headline Here</h5>
    <p>Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. </p>
  </div>
  <div class="col">
    <img src="/wp-content/themes/sage/resources/assets/images/icon_pc-shield.png" alt="icon" />
    <h5>Sample Headline Here</h5>
    <p>Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. Sample text goes here. </p>
  </div>
</div>
